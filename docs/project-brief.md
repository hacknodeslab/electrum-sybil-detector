...
- **Fee-histogram determinism** — launch-blocker #2. Empirical verification pending: run two ElectrumX frontends against one Core, diff output. If not bit-identical, soften language to "strongly correlated".
